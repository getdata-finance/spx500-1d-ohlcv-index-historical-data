...
**SPX500 1d OHLCV index historical data** — ultra high-quality 1d OHLCV for **S&P 500**. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
df = pd.read_csv('SPX500_1d.csv', parse_dates=['time'])
